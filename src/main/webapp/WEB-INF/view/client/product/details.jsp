                        ...
                        <div class="col-lg-8 col-xl-9">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <h5 class="fw-bold mb-3">Gía bán: <p style="font-size:15px;text-align:center; width:100%;" >
                                        ...
                                        <ul class="list-unstyled fruite-categorie">
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="#"><i class="fas fa-apple-alt me-2"></i>Đồ ăn vặt</a>
                                                    <span>(3)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="#"><i class="fas fa-apple-alt me-2"></i>Đồ nướng</a>
                                                    <span>(5)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="#"><i class="fas fa-apple-alt me-2"></i>Đồ chay</a>
                                                    <span>(2)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="#"><i class="fas fa-apple-alt me-2"></i>nước uống</a>
                                                    <span>(8)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="#"><i class="fas fa-apple-alt me-2"></i>Các loại ăn vặt khác</a>
                                                    <span>(5)</span>
                                                </div>
                                            </li>
                                        </ul>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-item">
                                ...
                                <img src="client/mg/payment.png" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
